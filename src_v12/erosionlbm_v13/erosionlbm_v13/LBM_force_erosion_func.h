...
void erosion(Solid_list& solid_list, momentum_direction& e, vector3Ncubed& F_momentumexchange, density& rho, direction_density& f, int forcedirection, FILE * solfile, density& erodelist, Normalvector& nhat, vectorNcubed& ero_reso_check, vectorNcubed& F_vdw, FILE * errorfile);
