...
double VDW_0 = 2.5*1e-5; //Wan-Der-Waals force
int updatefreq = 700;
double c = 1.;
double tau = 0.515;
...
double Delta_T = 20.*Bvel[0] * sphere_radius / Bvel[0] + 100.; //Need Delta_T to be bigger than characteristic time. Hence, the factor in front of L/U.
